...
module.exports = (req, res) => {
        ...
        let createMenuTable = "CREATE TABLE IF NOT EXISTS menu ( id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, name varchar(255) NOT NULL, description varchar(255) NOT NULL, short_description varchar(255) NOT NULL, price INT(11) NOT NULL, date_created varchar(255) NOT NULL );";
        ...
        connection.query(createMenuTable, function (err) {
                if (err) {
                    ...
                    res.render('menu/index', {db_error:err.toString()});
                }

                connection.query(insertMenuTable,[name, short_description, description, +price,today()], (err)=>{
                    if(err){
                        console.log(err.toString());
                        res.render('menu/index', {dberror:err.toString(), error:[]});
                    }
